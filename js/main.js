...
$(document).ready(function(){
	...
	//littlestar filter
	littlestarFilter($(".littlestar-filter-btn.active").attr("data-target"))
	$(".littlestar-filter-btn").click(function(){
		if(!$(this).hasClass("active")){
			littlestarFilter($(this).attr("data-target"))
		}
	})
	function littlestarFilter(target){
		$(".littlestar-filter-btn").removeClass("active");
		$(".littlestar-filter-btn[data-target='"+target+"']").addClass("active");
		$(".littlestar-item").hide();
		$(".littlestar-item[data-category='"+target+"']").fadeIn();
	}
	//gallery popup
